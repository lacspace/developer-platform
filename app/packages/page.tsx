...
const seo = site.page({
  ...
  path: "/packages",
  description:
    "All 108 @lacspace packages — zero-dependency, isomorphic TypeScript. Search, filter by kit, switch package manager, and build a combined install command. Security, SEO, React, backend, mail, data and more.",
});
