...
const ROWS: Row[] = [
  ...
  { lac: "components", alt: "mui · chakra · shadcn/ui", category: "UI components", why: "96 components, no runtime deps and no Tailwind — themed by CSS variables, not by forking." },
  { lac: "charts", alt: "recharts · chart.js", category: "Charts", why: "Plain SVG, no canvas and no D3 — and the scale maths is exported on its own." },
  { lac: "table", alt: "tanstack-table · ag-grid", category: "Data tables", why: "A finished table AND a headless hook, with formula-safe CSV export built in." },
  { lac: "date", alt: "react-datepicker · react-day-picker", category: "Date pickers", why: "Date, range, month, week, time and a schedule grid; formats through Intl, so no locale data ships." },
