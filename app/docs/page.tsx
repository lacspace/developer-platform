...
const seo = site.page({
  ...
  path: "/docs",
  description:
    "The documentation home for Lacspace — install and scaffold in seconds, then dive into the per-package reference, the developer handbook, a live playground and the Free Licence. 104 zero-dependency packages, one CLI.",
});
export const metadata = seo.metadata;

const SURFACES = [
  { icon: "📦", title: "Package reference", d: "Every one of the 104 packages — API, exports, install and examples.", href: "/packages", cta: "Browse packages" },
        ...
        <section className="sec" style={{ paddingTop: 48 }}>
          <Reveal className="sec-head center">
            ...
            <p>
              ...
              reference, the handbook and a live playground. 104 zero-dependency packages, one CLI.
            </p>
          </Reveal>
