  ...
  return llmsTxtResponse(
    {
      ...
      summary:
        "102 zero-dependency, isomorphic TypeScript packages, the create-lacspace-app CLI, and the docs to build with them.",
      details:
      ...
      sections: [
        {
          ...
          links: [
            ...
            { title: "All packages", url: "https://developer.lacspace.com/packages", notes: "the full 102-package catalog" },
