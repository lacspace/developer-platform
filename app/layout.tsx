...
export const metadata: Metadata = {
  ...
  title: {
    default: `Lacspace Developer Platform — ${PACKAGE_COUNT} packages, one CLI, real docs`,
    template: "%s",
  },
  ...
  openGraph: {
    ...
    title: `Lacspace Developer Platform — ${PACKAGE_COUNT} packages, one CLI, real docs`,
    description: site.config.description,
    images: [
