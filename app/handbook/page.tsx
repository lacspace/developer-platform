...
const seo = site.faq(FAQ, {
  ...
  path: "/handbook",
  description:
    "The interactive guide to the Lacspace ecosystem — search, filter and copy real recipes for secure auth, SEO, backend, money, data, React and resilience across 102 zero-dependency TypeScript packages.",
});
