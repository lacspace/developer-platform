...
money(19.99, "USD").format();       // "$19.99"`,
  ...
  },
  {
    ...
    icon: "🧱",
    kit: "Start",
    intro: "Four rules hold across the whole catalog — which is what makes 104 packages feel like one standard library.",
    recipes: [
      {
        id: "rules",
...
export const RESOURCES = [
  { label: "All 104 packages", href: "/packages", icon: "📦" },
