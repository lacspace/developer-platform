...
money(19.99, "USD").format();       // "$19.99"`,
  ...
  },
  {
    ...
    icon: "🧱",
    kit: "Start",
    intro: "Four rules hold across the whole catalog — which is what makes 117 packages feel like one standard library.",
    recipes: [
      {
        id: "rules",
...
export const RESOURCES = [
  { label: "All 117 packages", href: "/packages", icon: "📦" },
