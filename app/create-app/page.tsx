...
const STEPS = [
  ...
  { n: "02", t: "Pick a template + add-ons", d: "Nine templates. Choose static (frontend only) or --fullstack — frontend plus a real Node/Express/MongoDB/Redis backend. Then layer on --with ai-chat / rag for a streaming AI chat or chat-with-your-docs — free & keyless." },
    ...
    <>
      ...
      <main className="wrap">
        ...
        <section className="hero">
          <Reveal><span className="pill"><span className="live" /> Open source · 9 templates · AI add-ons · full-stack mode · 0.12s scaffold</span></Reveal>
          <Reveal delay={60}>
